...
class LLMBundle:
    def __init__(self, tenant_id, llm_type, llm_name=None, lang="Chinese"):
        ...
        print(f"support tool call: {self.is_tools}")
        print(f"get config: {model_config}")
    ...
    def _chat_streamly_with_tools(self, system, history, gen_conf):
        print("OKKKKKKKK enter ok")
        ans = ""
        try:
            for txt in self.mdl.chat_streamly_with_tools(system, history, gen_conf):
                print("normallllllllllllllllllllllllllllllllllll")
    ...
    def chat_streamly(self, system, history, gen_conf):
        ...
        ans = ""
        if self.is_tools and self.mdl.is_tools:
            print("GGGGGGGGGGGGGGGGGGGGGGGGGGGGOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOooo")
            try:
